...
import time
import requests
from requests.packages.urllib3.exceptions import InsecureRequestWarning  # Add this import
...
requests.packages.urllib3.disable_warnings(InsecureRequestWarning)  # Add this line
...
def send_event(msg, agent=None):
    ...
    sock.close()
    print("Sent Event:", string)  # Add this line---------------
false = False
...
alert_file.close()
print("Alert Data:", alert)  # Add this line----------------------
# New Alert Output if MISP Alert or Error calling the API
alert_output = {}
print("Alert Output:", alert_output)  # Add this line----------------
# MISP Server Base URL
misp_base_url = "https://192.168.253.145/attributes/restSearch/"
# MISP Server API AUTH KEY
misp_api_auth_key = "zQYt3pUk8l20rD8g8CU0DvZPT5P6zu7Pyl3ZwyR8"
# API - HTTP Headers
...
if event_source == "windows":
    ...
    print("MISP Search URL:", misp_search_url)  # Add this line----------
    try:
        misp_api_response = requests.get(
            misp_search_url, headers=misp_apicall_headers, verify=False
        )
        print("MISP API Status Code:", misp_api_response.status_code)  # Add this line-----------------
        print("MISP API Response Headers:", misp_api_response.headers)  # Add this line--------------------
        ...
        print("MISP API Response:", misp_api_response.text)  # Add this line-------------
        ...
        if misp_api_response["response"]["Attribute"]:
            ...
            alert_output["misp"]["source"]["description"] = alert["rule"].get("description", "No description available")
            send_event(alert_output, alert["agent"])
